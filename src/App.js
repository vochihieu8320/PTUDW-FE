...
import UserWatchList from './views/User_WatchList';
import UpgradeToSeller from './views/Upgrade_to_Seller';
import UserSearchProduct from './views/Search_Product';
      ...
      return (
          <Router>
             <Switch>
                ...
                <Route exact path = "/user/upgradetoseller">
                    <Navbar/>
                    <UpgradeToSeller />
                    <Footer/>
                </Route>
